...
<body>
    <header class="container d-flex justify-content-between p-5 w-100 text-center ">
        <h1>Produtos</h1>
    ...
    <main>
        <div>
            <h2 class="text-center mb-5">Compre aqui, <?= $_SESSION['usuario']['nome'] ?>!</h2>
        </div>
        ...
        <div class="container-fluid d-flex justify-content-center mt-3">
            <button class="btn btn-primary btn-lg" onclick="location.href='index.php'">Voltar</button>
        </div>
